...
\begin{itemize}
  \item 参与将短期工作拆为可匹配、可验收的任务单元，设计并实现任务发布、OPC 匹配、资金托管、履约记录、交付验收与争议举证的 PC 端原型。
  \item 在团队中参与需求讨论、功能取舍和版本交付；\href{https://mp.weixin.qq.com/s/SlfiV_kPU5RST9fHOxSfCg}{项目介绍}。
\end{itemize}
...
\begin{itemize}
  \item 围绕生信实践、AI 工具、产品迭代与职业探索进行选题、写作和视频制作；在小红书账号内运营 2 个近 500 人社群，并同步在微信更新内容。
